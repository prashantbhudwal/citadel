...
async function main() {
  console.log(
    '📦 Extracting Ultra-Dense Solo Studio Songs (>= 1000 words) to JSON...\n',
  )
  ...
  // Apply the same 300-word pipeline logic, but threshold at 1000
  ...
  const outPath = path.resolve(process.cwd(), 'data/solo-studio-over-1000.json')
